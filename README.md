...
- WP(7/8), Windows 8, Windows 8.1, and Windows Phone 8.1 are not supported by this version branch, now supported in: [litehelpers / Cordova-sqlite-legacy](https://github.com/litehelpers/Cordova-sqlite-legacy)
...
- Status for the other target platforms:
  - Android: now using [Android-sqlite-connector](https://github.com/liteglue/Android-sqlite-connector) (with sqlite `3.7.17`), with support for FTS3/FTS4 and R-Tree, and REGEXP support using PCRE 8.37 as built from [liteglue / Android-sqlite-native-driver-regexp-pcre](https://github.com/liteglue/Android-sqlite-native-driver-regexp-pcre)
  - iOS: sqlite `3.8.10.2` embedded
- FTS3, FTS4, and R-Tree support is tested working OK in this version (for target _all_ platforms ~~Android/iOS/Windows "Universal"~~)
...
- [litehelpers / Cordova-sqlite-storage](https://github.com/litehelpers/Cordova-sqlite-storage) - _core version for Android and iOS_
...
For Android, Amazon Fire-OS, iOS, and Windows "Universal": put the database file in the `www` directory and open the database like _(with iCloud backup disabled)_:
...
- https://github.com/litehelpers/cordova-sqlite-ext - _latest version_
- `cordova-sqlite-ext` - _stable npm package version_
...
- `src`: platform-specific source code:
   - `external` - placeholder ~~used to import `sqlite3.[hc]` in this version branch-needed to build Windows "Universal" (8.1) version~~ _not needed in this version branch_
...
- Which platform(s) Android/iOS/~~WP8~~/Windows _(10)_ ~~8.1/Windows Phone 8.1~~
